              ...
              <div className="col-lg-3 col-md-6 col-sm-12 col-12">
                <div className="edu-footer-widget">
                  ...
                  <p className="description">
                    ATDT - bu "ATDT" kafedrasi faoliyati uchun zamonaviy tizim.
                    Bu yerda kafedraga taa'luqli ma'lumotlaridan tortib,
                    o'qituvchilar tomonidan qo'yilgan foydali bloglarni o'qib
