                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-12 col-sm-6 d-none d-sm-block">
                        <div className="thumbnail">
                          <img
                            className="main-img"
                            src="/images/footer/cta-image-01.png"
                            alt="Cta images"
                          />
                          <div className="shape-image">
                            <img
                              src="/images/footer/shape-05.png"
                              alt="Shape Images"
                            />
                          </div>
                        </div>
                  ...
                  <div className="inner">
                    <div className="content">
                      <div className="section-title text-white">
                        ...
                        <h5 className="title">
                          Be The First know About Courses
                          <br />
                          And Event !
                        </h5>
                      </div>
                    ...
                    <div className="inner">
                      <div className="widget-information">
                        <ul className="information-list">
                          <li>
                            <i className="icon-map-pin-line"></i>275 Quadra
                            Street Victoria Road, New York
                          </li>
                          <li>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="inner text-center">
                  <p>
                    Copyright 2022 <a href="#">EduVibe</a> Designed By{" "}
