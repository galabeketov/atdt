        ...
        <div className="container eduvibe-animated-shape">
            ...
            <div className="col-xl-10 offset-xl-1">
              <div className="content text-center">
                ...
                <div className="newsletter-style-6">
                  <form
                    className="newsletter-form-style-2"
                    action="#">
                    <input
                      type="email"
          ...
          <div className="shape-dot-wrapper shape-wrapper d-xl-block d-none">
            <div className="shape-image shape-image-1">
              <img
                src="/images/shapes/shape-11-06.png"
                alt="Shape Thumb"
              />
            </div>
            <div className="shape-image shape-image-2">
              <img
                src="/images/shapes/shape-09-02.png"
                alt="Shape Thumb"
              />
            </div>
            ...
            <div className="shape-image shape-image-4">
              <img
                src="/images/shapes/shape-14-04.png"
                alt="Shape Thumb"
              />
            </div>
            <div className="shape-image shape-image-5">
              <img
                src="/images/shapes/shape-03-08.png"
                alt="Shape Thumb"
              />
            </div>
            <div className="shape-image shape-image-6">
              <img
                src="/images/shapes/shape-01-02.png"
                alt="Shape Thumb"
              />
            </div>
          </div>
